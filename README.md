...
The project uses the C++ programming language. I used the application VS Community for this specific project. I also used my knowledge on opening and closing files, retrieving user input, and storing input into strings. 

## WHAT I LEARNED

I learned that creating a login application doesn't have to be overly complicated. Especially for beginner programmers. I also learned that you can always improve onto simple applications like this one. If I included things like input validation or encryption for passwords, it could make my program even better and help me become a better developer in the long run. 
